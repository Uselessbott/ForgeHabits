      ...
      >
        ...
        <View style={[styles.scoreCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={styles.scoreDetails}>
            ...
            <View style={styles.scoreRow}>
              <Text style={[styles.scoreNum, { color: colors.foreground }]}>{longestStreak}</Text>
              <Text style={[styles.scoreDesc, { color: colors.mutedForeground }]}>longest</Text>
            </View>
          </View>
        </View>
              ...
              return (
                <View key={cat.id} style={styles.section}>
                  ...
                  {catHabits.map(habit => {
                    ...
                    const weeklyProgress = habit.frequency === 'weekly_target' ? getWeeklyTargetProgress(habit.id, weekStart) : undefined;
                    return (
                      <HabitCard
                        key={habit.id}
                        habit={habit}
...
const styles = StyleSheet.create({
  ...
  scoreCard: { borderRadius: 16, borderWidth: 1, padding: 20, flexDirection: 'row', alignItems: 'center', gap: 24, marginBottom: 24 },
